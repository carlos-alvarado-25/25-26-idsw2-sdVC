...
|![](/documentos/00-modelo-del-dominio/DiagramaDeClases/DiagramaDeClasesGeneradorExamenes.svg)
|:-:
|[Código fuente](/documentos/00-modelo-del-dominio/DiagramaDeClases/DiagramaDeClasesGeneradorExamenes.puml)
...
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| ![](/documentos/00-modelo-del-dominio/DiagramaDeObjetos/DiagramaDeObjetosGeneradorExamenes.svg)<br>[Código fuente](/documentos/00-modelo-del-dominio/DiagramaDeObjetos/DiagramaDeObjetosGeneradorExamenes.puml) | ![](/documentos/00-modelo-del-dominio/DiagramaDeObjetos/SegundoDiagramaDeObjetosGeneradorExamenes.svg)<br>[Código fuente](/documentos/00-modelo-del-dominio/DiagramaDeObjetos/SegundoDiagramaDeObjetosGeneradorExamenes.puml) |
...
| :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| ![](/documentos/00-modelo-del-dominio/DiagramaDeEstados/DiagramaDeEstadosDeUnExamen.svg)<br>[Código fuente](/documentos/00-modelo-del-dominio/DiagramaDeEstados/DiagramaDeEstadosDeUnExamen.puml) | ![](/documentos/00-modelo-del-dominio/DiagramaDeEstados/DiagramaDeEstadosGeneradorExamenes.svg)<br>[Código fuente](/documentos/00-modelo-del-dominio/DiagramaDeEstados/DiagramaDeEstadosGeneradorExamenes.puml) |
...
README hacia el [Glosario](/documentos/00-modelo-del-dominio/Glosario/README.md) del modelo del dominio
