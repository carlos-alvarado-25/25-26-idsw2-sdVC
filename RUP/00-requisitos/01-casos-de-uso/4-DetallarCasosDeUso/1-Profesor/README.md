...
# Detallado de los casos de uso del actor Profesor

## comunicarIncidenciasHorario()

<div align=center>
	
|![](/images/00-requisitos/01-casos-de-uso/4-DetallarCasosDeUso/1-Profesor/comunicarIncidenciasHorario/comunicarIncidenciasHorario.svg)
|:-:
|[Código fuente](/modelosUML/00-requisitos/01-casos-de-uso/4-DetallarCasosDeUso/1-Profesor/comunicarIncidenciasHorario/comunicarIncidenciasHorario.puml)
...
|![](/images/00-requisitos/01-casos-de-uso/4-DetallarCasosDeUso/1-Profesor/descargarCalendarioExamenes/descargarCalendarioExamenes.svg)
|:-:
|[Código fuente](/modelosUML/00-requisitos/01-casos-de-uso/4-DetallarCasosDeUso/1-Profesor/descargarCalendarioExamenes/descargarCalendarioExamenes.puml)
...
|![](/images/00-requisitos/01-casos-de-uso/4-DetallarCasosDeUso/1-Profesor/consultarCalendario/consultarCalendario.svg)
|:-:
|[Código fuente](/modelosUML/00-requisitos/01-casos-de-uso/4-DetallarCasosDeUso/1-Profesor/consultarCalendario/consultarCalendario.puml)

</div>

---

**Total: 3 casos de uso detallados para el Profesor**
