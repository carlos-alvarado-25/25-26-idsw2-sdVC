...
## Descripción
Implementación del caso de uso del motor de calendarización automática de exámenes. Se introdujo una arquitectura basada en **Invención Pura** (`CalendarioEngine`) y **Experto en Información** en las entidades `Aula` y `Profesor` para desacoplar el algoritmo de asignación combinatorial de las dependencias de TypeORM.
