...
2. **Carga Inicial**: La vista solicita la primera página del listado al `ProfesorController`.
3. **Consulta**: El controlador recupera los datos paginados (`PagedResult<Profesor>`) desde `ProfesorRepository`.
...
|-|-|-|
|Presentar lista de profesores|`ListarProfesoresView`|`listarProfesores(filtros, pagina)`|
